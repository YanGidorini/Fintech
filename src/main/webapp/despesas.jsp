											...
											<div class="mt-3">
						                        ...
						                        <div class="row">
						                            ...
						                            <div class="col-auto d-flex mt-3 mt-sm-0">
						                                <button class="button me-2 me-sm-3" type="button" title="Editar despesa" data-bs-toggle="modal" data-bs-target="#editModal" onclick="edition.value = '${despesa.idDespesa}'; nome.value = '${despesa.nome}'; valor.value = '${despesa.valor}'; data.value = '${despesa.dtDespesa}' ; time.value = '${despesa.hora}' ">
